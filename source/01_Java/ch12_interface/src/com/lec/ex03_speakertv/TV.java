...
public class TV implements IVolume{
	...
	public void volumeUp() {//볼륨을 1씩증가
		if(volumeLevel < MAX_VOLUME) {
			...
			System.out.println("TV 볼륨이 최대치("+MAX_VOLUME+")여서 올리지 못합니다.");
		}
	}
	...
	public void volumeDown() {
		if(volumeLevel > MIN_VOLUME) {
			...
			System.out.println("TV 볼륨이 최소치("+MIN_VOLUME+")여서 내리지 못합니다.");
	...
	public void volumeDown(int level) {
		if(volumeLevel - level > MIN_VOLUME) {
			...
			System.out.println("TV 볼륨을" + tempLevel + "만큼 내려 최소치입니다.");
		}
