...
public class Ex03_Random {
	public static void main(String[] args) {
		...
		System.out.println("0~100까지의 정수 난수 : " + random.nextInt(101)); //정수 난수
		System.out.println("0~44까지의 정수 난수 : " + random.nextInt(45)); //정수 난수
		System.out.println("1~45까지의 정수 난수 : " + (random.nextInt(45)+1)); //정수 난수
