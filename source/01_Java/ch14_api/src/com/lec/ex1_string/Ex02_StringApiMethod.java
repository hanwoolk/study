...
public class Ex02_StringApiMethod {
	public static void main(String[] args) {
		...
		System.out.println("3." + str1.substring(3,5)); // 3번째부터 5번 앞까지 3.Xa
		...
		System.out.println("10." + str4.indexOf("b",3)); // 3인덱스부터 나오는 첫번째 b 인덱스 : 10.5
		...
		System.out.println("16." + str3.trim());		//앞 뒤 space제거 : 16.ja va2
