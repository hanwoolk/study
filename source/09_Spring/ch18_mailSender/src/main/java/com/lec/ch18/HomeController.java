...
public class HomeController {
	...
	public String textMail(String name, String email, Model model) {
		...
		//message.setFrom("hanwool.kim0312@gmail.com"); //보낼 메일 주소
	...
	public String htmlMail(final String name,final String email, Model model) {
		MimeMessagePreparator message = new MimeMessagePreparator() {
			String content = "	<div style=\"width:500px; margin:0 auto;\">\n" + 
					...
					"		<p><img src=\"https://t1.daumcdn.net/daumtop_chanel/op/20200723055344399.png\" alt=\"다음 로고\"></p>\n" + 
					"		<hr color=\"red\">\n" + 
					"		<span style=\"color:red\"> 빨간 글씨 부분</span><br>\n" + 
					"		<span style=\"color:blue\"> 파란 글씨 부분</span>\n" + 
					"		<p><img src=\"http://localhost:8090/ch18/img/coupon.jpg\" alt=\"쿠폰 이미지\"></p>\n" + 
					"		<p>서울시 어떤구 몰라17길 51 어떤빌딩 2층</p>\n" + 
					"	</div>";
			@Override
			public void prepare(MimeMessage mimeMessage) throws Exception {
				...
				//보낼 메일
				//mimeMessage.setFrom(new InternetAddress("hanwool.kim0312@gmail.com"));
				//메일 제목
