...
public class ProxyClass {
	...
	public Object aroundAdvice(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		long startTime = System.currentTimeMillis(); // 시작 시작시점의 밀리세컨
		try {
	...
	public void afterAdvice() {
		System.out.println("핵심기능 수행후  afterAdvice() 자동 수행");
		
	}
	// afterReturning advice : 핵심기능을 에러없이 수행 후 공통기능 수행
	public void afterReturningAdvice() {
		System.out.println("핵심기능 에러없이 수행 후 afterReturning() 자동 수행");
	}
	// afterThrowing advice : 핵심기능에 예외 발생 후 공통기능 수행
	public void afterThrowingAdvice() {
		System.out.println("핵심기능 예외 발생 후 afterThrowing() 자동 수행");
	}
