...
-- DAO에 들어갈 QUERY
-- 1. 글 목록 (startRow ~ endRow까지) id=list
...
-- 5-1. bID로 DTO 가져오기 (글 상세보기, 글수정 VIEW, 답변글VIEW) id=content , modifyView_replyView
...
-- 8. 답변글 달기 전 작업 (STEP ⓐ : 예시에서는 2번글의 답변) id=preReplyStep
