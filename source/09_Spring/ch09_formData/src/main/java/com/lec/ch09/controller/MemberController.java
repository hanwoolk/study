...
public class MemberController {
	...
	@RequestMapping(value="join1", method=RequestMethod.GET) // 파일첨부시 어쩔수 없이 써야함
	...
	// String membername = request.getParamemter("name");
	@RequestMapping(value="join3", method=RequestMethod.GET) // ★ 로그인 서비스에
...
//	}
	@RequestMapping(value="join4", method=RequestMethod.GET)
	public String join4(MemberDto memberDto, Model model) { // 매개변수 없는 생성자 함수, setter가 있어야함
