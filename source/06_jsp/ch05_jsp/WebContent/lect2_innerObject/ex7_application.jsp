...
<body>
	<%
		String conPath = request.getContextPath(); // "/ch05_/jsp"
	String appPath = application.getContextPath(); // "/ch05_/jsp"
	...
	// 1. 스트림객체 생성(파일연다. 기본스트림->보조스트림) 2.읽고 화면출력 3.스트림객체 닫는다(파일을닫는다) 
...
/* 	Reader reader = null;
	...
	try {
		...
		br = new BufferedReader(reader); //보조 스트림 생성 (기본 스트림을 통해 생성)
		while (true) {
