...
<body>
	...
	<form action="${conPath }/modify.do" method="post">
		...
		<table>
			...
			<tr>
				<th>작성자</th><td><input type="text" name="bname" value="${modifyBoard.bname }" required="required" autofocus="autofocus"></td>
			</tr>
			<tr>
				<th>제목</th><td><input type="text" name="btitle" value="${modifyBoard.btitle }" required="required"></td>
			</tr>
			<tr>
				<th>본문</th><td><pre><textarea rows="5" name="bcontent">${modifyBoard.bcontent }</textarea></pre></td>
			</tr>
			<tr>
				<td colspan="2">
