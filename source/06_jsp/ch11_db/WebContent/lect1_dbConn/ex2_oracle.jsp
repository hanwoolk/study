	...
	<%
		...
		try{
			...
			if(rs.next()){//데이터가 있는경우
				...
				do{ //while하면 첫번째줄은 출력 안돼서 do while로
						//6단계 : 결과 받아 적당한 로직 수행
						...
						out.println("<tr><th>"+empno+"</th><th>"+ename+"</th><th>"+job+"</th><th>"+mgr+"</th><th>"+hiredate+"</th><th>"+hiredateD+"</th><th>"+hiredateT+"</th><th>"+sal+"</th><th>"+comm+"</th><th>"+deptno+"</th></tr>");
					}while(rs.next());
			}else{ //데이터가 없는경우
