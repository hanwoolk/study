...
<body>
	<%
		...
		for(String imgfile : images){
			...
			if(serverFile.exists()){
				try{
					...
					os = new FileOutputStream("D:/KHW/source/06_jsp/ch14_fileUp/WebContent/bookImg/"+imgfile);
		...
		//String	ip 				= request.getRemoteAddr();	ip가 필요한경우는 request 이용			
	...
	%>
	<h3>책 이름<%=btitle %></h3>
	<h3>책 가격<del><%=bprice %></del>
		<b>
			<%=bprice*(100-bdiscount)/100 %>원
			(<%=bdiscount%>% 할인)
		</b>
	</h3>
