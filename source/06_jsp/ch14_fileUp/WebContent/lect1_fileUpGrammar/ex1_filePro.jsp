...
<body>
	<%
		...
		try{
			...
			if(serverFile.exists()){
				...
				os = new FileOutputStream("D:\\KHW\\source\\06_jsp\\ch14_fileUp\\WebContent\\fileUpFolder/" + filename); // 소스폴더로 복사될 파일
	...
	<%}else{
			out.println("<h2>첨부 안 함: filename="+filename+" / 오리지널 파일 이름 = "+originalFilename+"</h2>");
		}%>
</body>
</html>