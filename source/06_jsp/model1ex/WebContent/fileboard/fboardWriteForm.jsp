...
<body>
	...
	<div id="content_form" style="padding:40">
		<%
			//fboartWriteForm.jsp => 원글쓰기
			//											fsubject, fcontent, ffilename, fpw(사용자)
			//											fref, fre_step, fre_level (0으로 넘김)
			//fboartWriteForm.jsp?fnum=1&pageNum=9 =>1번글에 대한 답글쓰기
			//											fsubject, fcontent, ffilename, fpw(사용자)
			...
			FileboardDto fDto = new FileboardDto(); // 빈dto 객체 생성(fnum, fref, fre_step, fre_level은 0);
