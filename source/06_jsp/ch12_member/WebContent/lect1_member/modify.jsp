...
<body>
	<%!	String id, name, phone1, phone2, phone3, gender, email, address; Date birth;
	%>
	<%
	...
	<form action="modifyOk.jsp" method="post">
		<table>
			...
			<tr>
				<th>새 비밀변호</th>
				<td><input type="password" name="pw" placeholder="비밀번호 수정을 원하지 않으면 빈칸으로 두세요"></td>
			</tr>
			<tr>
				<th>새 비밀변호</th>
			...
			<tr>
				<th>생년월일</th>
				<%--Date형의 경우 : burth.toString() "1995-12-12" --%>
				<td><input type="date" name="tempBirth" value='<%=birth==null? "":birth.toString()%>'></td>
				<%--Timestamp형의 경우 : burth.toString() "1995-12-12 --:00:00" --%>
