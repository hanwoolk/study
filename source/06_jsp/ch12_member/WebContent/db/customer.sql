...
INSERT INTO CUSTOMER (CID, CPW, CNAME, CTEL, CEMAIL, CADDRESS, CBIRTH, CGENDER, CRDATE)
    VALUES ('aaa','111','홍','010-9999-9999','h@h.com','서울',TO_DATE('1995-12-12','YYYY-MM-DD'),'m',SYSDATE);
